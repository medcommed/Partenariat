...
describe('Tranche Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tranche', component: TrancheComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tranches?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to trancheService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTrancheIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTrancheIdentifier).toHaveBeenCalledWith(entity);
