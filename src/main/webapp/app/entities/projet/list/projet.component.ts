...
import { EntityArrayResponseType, ProjetService } from '../service/projet.service';
...
export class ProjetComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProjet): number => this.projetService.getProjetIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.projets = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProjet[] | null): IProjet[] {
    return data ?? [];
  }
