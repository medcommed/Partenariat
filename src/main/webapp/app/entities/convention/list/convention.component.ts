...
import { EntityArrayResponseType, ConventionService } from '../service/convention.service';
...
export class ConventionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IConvention): number => this.conventionService.getConventionIdentifier(item);
