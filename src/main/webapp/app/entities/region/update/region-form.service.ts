...
type RegionFormGroupContent = {
  ...
  libelleRegionAr: FormControl<IRegion['libelleRegionAr']>;
  libelleRegionFr: FormControl<IRegion['libelleRegionFr']>;
};
...
export class RegionFormService {
  createRegionFormGroup(region: RegionFormGroupInput = { id: null }): RegionFormGroup {
    ...
    return new FormGroup<RegionFormGroupContent>({
      ...
      libelleRegionAr: new FormControl(regionRawValue.libelleRegionAr, {
        validators: [Validators.required, Validators.maxLength(255)],
      }),
      libelleRegionFr: new FormControl(regionRawValue.libelleRegionFr, {
