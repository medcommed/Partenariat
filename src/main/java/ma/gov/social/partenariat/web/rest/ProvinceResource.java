...
import ma.gov.social.partenariat.service.ProvinceQueryService;
...
/**
 * REST controller for managing {@link ma.gov.social.partenariat.domain.Province}.
 */
@RestController
@RequestMapping("/api")
public class ProvinceResource {
    ...
    public ResponseEntity<List<Province>> getAllProvinces(
        ...
        Page<Province> page = provinceQueryService.findByCriteria(criteria, pageable);
