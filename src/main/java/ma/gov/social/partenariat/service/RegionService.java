...
public class RegionService {
    ...
    public Optional<Region> partialUpdate(Region region) {
        ...
        return regionRepository
            ...
            .map(existingRegion -> {
                if (region.getLibelleRegionAr() != null) {
                    existingRegion.setLibelleRegionAr(region.getLibelleRegionAr());
                }
                if (region.getLibelleRegionFr() != null) {
                    existingRegion.setLibelleRegionFr(region.getLibelleRegionFr());
                }
